!(function (t, e) {
  ...
  function resetFormStep1() {
    ...
    // Clear validation messages for step 1
    formElementsStep1.forEach((element) => {
  ...
  function addCustomValidations() {
    ...
    const step1Fields = ['type', 'OperationalStatus', 'group', 'owner', 'inputProblemSummary'];
    ...
    const inputBillingCCType = formStep2.querySelector("#inputBillingCCType");

    inputBillingCCNumber.addEventListener('input', validateNumbers);
    inputBillingName.addEventListener('input', validateLetters);
    inputBillingCCType.addEventListener('input', validateLetters);
  }
